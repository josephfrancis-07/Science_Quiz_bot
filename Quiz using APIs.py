...
while data_validation3==False:
    ...
    #generating list of options and inserting the correct answer into a random position
        ...
        options=[]
        options.append(string['results'][0]['incorrect_answers'][0])
        options.append(string['results'][0]['incorrect_answers'][1])
        options.append(string['results'][0]['incorrect_answers'][2])
        options.insert((rand.randint(0, 3)),string['results'][0]['correct_answer'])
